 ...
 */
    ...
    hasMajorDiagonalConflictAt: function(majorDiagonalColumnIndexAtFirstRow) {
      ...
      for (var i = 0; i < this.attributes.n; i++) {
        for (var j = 0; j < this.attributes.n; j++) {
          if (majorDiagonalColumnIndexAtFirstRow === i-j && this.attributes[i][j] == 1) {
            number++;
          };
        };
      };
    ...
    hasAnyMajorDiagonalConflicts: function() {
      var count = 0 - this.attributes.n;
      for (var i = count; i < this.attributes.n; i++) {
    ...
    hasMinorDiagonalConflictAt: function(minorDiagonalColumnIndexAtFirstRow) {
      ...
      for (var i = 0; i < this.attributes.n; i++) {
        for (var j = 0; j < this.attributes.n; j++) {
          if (minorDiagonalColumnIndexAtFirstRow === i+j && this.attributes[i][j] == 1) {
            number++;
          };
        };
      };
